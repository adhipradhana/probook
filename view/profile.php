...
<body>
	...
	<div class="profile-pic">
		<span class="edit-pic">EDIT ICON</span>
	...
	<div class="user-profile">
		...
		<table class="table-profile">
			<tr>
				...
				<td class="width-65">@tayotayo</td>	
			</tr>
			<tr>
				<td class="width-35">Email</td>	
				<td class="width-65">tayo@littlebus.com</td>	
			</tr>
			<tr>
				<td class="width-35">Address</td>	
				<td class="width-65">120 Garage Street, Unit B. Korea.</td>	
			</tr>
			<tr>
				<td class="width-35">Phone Number</td>	
				<td class="width-65">081234567890</td>	
			</tr>
		</table>
	</div>
</body>
